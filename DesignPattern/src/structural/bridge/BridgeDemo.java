...
can be drawn in different colors using same abstract class method but different bridge 
implementer classes.
 */
public class BridgeDemo {

	public static void main(String[] args) {
		Shape shape1 = new Circle(10, 10, 10, new GreenCircle());
		shape1.draw();
		Shape shape2 = new Circle(10, 10, 10, new RedCircle());
		shape2.draw();
	}
